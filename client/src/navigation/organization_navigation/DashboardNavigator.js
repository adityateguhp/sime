...
export default function DashboardNavigator({ route, navigation }) {
  ...
  return (
    ...
    >
      ...
      <DashboardStack.Screen name="Staff Organization Profile" component={StaffOrganizationProfileScreen} options={{
        headerTitle: () => (
          <View>
            <Text style={{ fontSize: 20, fontWeight: 'bold', color: 'white' }} numberOfLines={1} ellipsizeMode='tail'>Organization Information</Text>
          </View>),
      }} />
      <DashboardStack.Screen name="Person in Charge Profile" component={PersonInChargeProfileScreen} options={{
        headerTitle: () => (
          <View>
            <Text style={{ fontSize: 20, fontWeight: 'bold', color: 'white' }} numberOfLines={1} ellipsizeMode='tail'>Person in Charge Information</Text>
          </View>),
      }} />
      <DashboardStack.Screen name="Event Detail" component={TopTabEvents} options={{
        headerTitle: () =>
          <View>
      ...
      <DashboardStack.Screen name="External List" component={ExternalListScreen} options={{
        headerTitle: () =>
          <View>
      ...
      <DashboardStack.Screen name="External Profile" component={ExternalProfileScreen} options={{
        headerTitle: () => (
          <View>
            <Text style={{ fontSize: 20, fontWeight: 'bold', color: 'white' }} numberOfLines={1} ellipsizeMode='tail'>External Information</Text>
          </View>),
      }} />
      <DashboardStack.Screen name="Task" component={TaskScreen} options={{
        headerTitle: () =>
          <View>
